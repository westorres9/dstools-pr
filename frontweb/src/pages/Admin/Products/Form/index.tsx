...
const Form = () => {
  ...
  useEffect(() => {
    ...
    if (isEditing) {
      ...
      requestBackend({ url: `/products/${productId}` }).then((response) => {
        ...
        setValue('fullPrice', product.fullPrice);
        setValue('promoPrice', product.promoPrice);
        setValue('financePrice', product.financePrice);
  ...
  const onSubmit = (formData: Product) => {
    const data = {
      ...formData,
      fullPrice: String(formData.fullPrice).replace(',', '.'),
      promoPrice: String(formData.promoPrice).replace(',', '.'),
    };
            ...
            <div className="col-lg-6 product-crud-inputs-left-container">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <CurrencyInput
                      ...
                      data-testid="fullPrice"
                    />
                  )}
                />

                <div className="invalid-feedback d-block">
                  {errors.fullPrice?.message}
                </div>
              </div>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <CurrencyInput
                      ...
                      className={`form-control base-input ${
                        errors.promoPrice ? 'is-invalid' : ''
                      }`} //mostra o campo vermelho
                      disableGroupSeparators={true} //desabilita o ponto de milhar
                      value={field.value} // valor do campo
                      onValueChange={field.onChange} //evento de quando mudar o estado do input
                      data-testid="promoPrice"
                    />
                  )}
                />
              ...
              <div className="margin-bottom-30">
                <input
                  ...
                  name="financePrice"
                  data-testid="financePrice"
                />
                <div className="invalid-feedback d-block">
                  {errors.financePrice?.message}
                </div>
              </div>
